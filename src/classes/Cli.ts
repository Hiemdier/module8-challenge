  ...
  chooseVehicle(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        const selectedVehicleVin = answers.selectedVehicleVin;
        if (selectedVehicleVin === this.selectedVehicleVin) {
          console.log("The truck cannot tow itself.");
        } else {
          const selectedVehicle = this.vehicles.find(vehicle => vehicle.vin === selectedVehicleVin);
          if (selectedVehicle) {
            (this.vehicles.find(vehicle => vehicle.vin === this.selectedVehicleVin) as Truck).tow(selectedVehicle);
          } else {
